...
const IconBox       = markRaw({ template: `<svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>` })
const IconCash      = markRaw({ template: `<svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"/></svg>` })
...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Coaches',  href: '/admin/coaches',  icon: IconUserGroup },
      { label: 'Lanes',    href: '/lanes',           icon: IconMap },
      { label: 'Bookings', href: '/lanes/bookings',  icon: IconCalendar },
    ],
  },
  {
    label: 'Operations',
    items: [
      ...
      { label: 'Finance',   href: '/admin/finance',   icon: IconCash },
    ],
  },
  {
    label: 'Insights',
